...
public class WheelPicker<T> extends View {
    ...
    private void initAttrs(Context context, @Nullable AttributeSet attrs) {
        ...
        mHalfVisibleItemCount = a.getInteger(R.styleable.WheelPicker_halfVisibleItemCount, 4);
        ...
        mCurtainBorderColor = a.getColor(R.styleable.WheelPicker_wheelCurtainBorderColor, Color.parseColor("#f4f5f6"));
    ...
    private void initPaint() {
        ...
        mSelectedItemPaint.setTypeface(Typeface.DEFAULT_BOLD);
